    ...
    content: [
      {
        ...
        steps: [
          ...
          "Abaixo há o calendário do mês mostrando eventos e reuniões One-on-One agendadas para você.",
          "Também aparecem os avisos mais recentes da empresa.",
        ],
      },
      {
        subtitle: "Navegando no Calendário",
        steps: [
          "Clique nas setas ← → para ir para o mês anterior ou próximo.",
          "Dias com eventos aparecem com marcadores coloridos.",
          "Eventos criados manualmente aparecem na cor do tipo escolhido.",
          "Reuniões One-on-One aparecem em azul com o ícone 👥.",
          "Clique em um evento para ver os detalhes ou, no caso de uma reunião, ir direto para ela.",
        ],
      },
    ],
  },
    ...
    content: [
      ...
      },
      {
        ...
        steps: [
          ...
          "2. Para criar um aviso, clique em 'Novo Aviso'.",
          "3. Preencha o título, observação (opcional) e link (opcional).",
          "4. Defina para quem o aviso é destinado.",
          "5. Para desativar um aviso sem excluir, use o toggle de ativo/inativo.",
          "6. Para excluir, clique no ícone de lixeira.",
        ],
      },
    ],
  },
